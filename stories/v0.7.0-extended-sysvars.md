...
### epoch_info.zig (SKIPPED)

- [ ] ~~EpochInfo struct~~
- **Reason**: Not a sysvar - this is RPC response data only, not accessible in on-chain programs

### stake_history.zig (SKIPPED)

- [ ] ~~StakeHistory struct~~
- **Reason**: Not found in solana-sdk repository - may be validator-only code in agave repo
