...
### Phase 5: sdk_ids.zig (P2)

- [ ] 创建 `sdk/src/sdk_ids.zig`
- [ ] 集中定义所有程序 ID 常量
- [ ] 分类组织（system, loaders, sysvars, native programs）
- [ ] 添加单元测试
- [ ] 更新 `sdk/src/root.zig` 导出
...
- [ ] 扩展 `bpf_loader.zig`
- [ ] 运行测试验证
- [ ] 提交: "feat(bpf_loader): add loader-v3 instruction builders"

### Step 3: Phase 2 实施 ✅
- [x] 创建 `instruction_error.zig`
- [x] 运行测试验证 (SDK: 105→111 tests)
- [ ] 提交: "feat(sdk): add InstructionError type"
