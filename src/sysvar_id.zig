...
test "sysvar-ids: SLOT_HASHES constant" {
    const expected = "SysvarS1otHashes111111111111111111111111111";
    var buffer: [44]u8 = undefined;
    const result = SLOT_HASHES.toBase58(&buffer);
    try std.testing.expectEqualStrings(expected, result);
}

test "sysvar-ids: SLOT_HISTORY constant" {
    const expected = "SysvarS1otHistory11111111111111111111111111";
    var buffer: [44]u8 = undefined;
    const result = SLOT_HISTORY.toBase58(&buffer);
    try std.testing.expectEqualStrings(expected, result);
}
...
test "sysvar-ids: INSTRUCTIONS constant" {
    const expected = "Sysvar1nstructions1111111111111111111111111";
    var buffer: [44]u8 = undefined;
    const result = INSTRUCTIONS.toBase58(&buffer);
    try std.testing.expectEqualStrings(expected, result);
}

test "sysvar-ids: EPOCH_REWARDS constant" {
    const expected = "SysvarEpochRewards1111111111111111111111111";
    var buffer: [44]u8 = undefined;
    const result = EPOCH_REWARDS.toBase58(&buffer);
    try std.testing.expectEqualStrings(expected, result);
}

test "sysvar-ids: LAST_RESTART_SLOT constant" {
    const expected = "SysvarLastRestartS1ot1111111111111111111111";
    var buffer: [44]u8 = undefined;
    const result = LAST_RESTART_SLOT.toBase58(&buffer);
    try std.testing.expectEqualStrings(expected, result);
}
...
test "sysvar-ids: ALL_IDS array" {
    ...
    try std.testing.expect(SLOT_HASHES.equals(ALL_IDS[2]));
    try std.testing.expect(SLOT_HISTORY.equals(ALL_IDS[3]));
