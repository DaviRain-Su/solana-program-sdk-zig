...
/// `zig build` exposes:
///   * `test` — run the package's host-side unit tests and a
///     consumer-style `@import("spl_token_group")` fixture.
pub fn build(b: *std.Build) void {
    ...
    const spl_token_group_mod = b.addModule("spl_token_group", .{
    ...
    const package_tests = b.addTest(.{ .root_module = spl_token_group_mod });
