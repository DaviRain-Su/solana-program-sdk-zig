...
It also exposes BIP39 seed derivation, bundled English wordlist checksum
validation, caller-supplied wordlist validation, Solana hardened derivation-path handling, SLIP-0010 Ed25519
...
- Recover entropy from a BIP39 mnemonic and validate checksum bits through the
  bundled English wordlist or a caller-supplied `WordlistResolver`
